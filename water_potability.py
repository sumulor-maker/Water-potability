...
Original file is located at
    https://colab.research.google.com/drive/1CGwLEz2aT7WW7Z0FKNfQv4jYDKLcVuud
...
"""####Going by the table above, the only outliers we have are in the solids row however there are no missing values present in that row."""
